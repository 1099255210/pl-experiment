...
def main():
    ...
    train_sal_dir_1 = "Dataset/train/saliencymaps_u2net"
    train_sal_dir_2 = "Dataset/train/saliencymaps_u2net"
    ...
    test_sal_dir_1 = "Dataset/test/saliencymaps_u2net"
    test_sal_dir_2 = "Dataset/test/saliencymaps_u2net"
